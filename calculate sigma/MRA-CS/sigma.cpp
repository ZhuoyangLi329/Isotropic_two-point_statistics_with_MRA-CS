...
int main()
{
    ...
    {
        ifname=("/data1/quijote/lzy_pos/dm/halo/real_space/qjthaloreal"+std::to_string(ih)+".bin");
        ...
        force_kernel_type(1);   //Sphere kernel
        ...
        outname=("/data1/quijote/lzy_pos/result_sigma/qjthalo_real_sigma"+std::to_string(ih)+".txt");
